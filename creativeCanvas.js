...
let c = {
    ...
    main() {
        ...
        this.audio.play();
        this.audio.onplaying = (event) => { this.visualizer() };
    ...
    visualizer() {
        ...
        for (let i = 0; i < c.frAmount; i++) {
            ...
            for (let k = 0; k < c.barHeight; k += 1000 / c.power ** 2) {
        ...
        if (c.audio.ended === false) { requestAnimationFrame(c.visualizer) }
    }
}
